...
def criar_zonas() -> list[Zona]:
    ...
    boss_floresta_2 = Inimigo("Rei dos Espectros", 1400, 105, 55, 1900,
                              1100, [coroa_espectro, alma_rei, essencia_real])
    ...
    guardiao_sombrio = Inimigo("Guardiao Sombrio", 580, 110, 55, 540,
                               290, [fragmento_sombrio, alma_sombria])
